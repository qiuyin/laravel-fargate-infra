resource "aws_db_instance" "this" {
  ...
  // TODO: 再設定：aws rds modify-db-instance --db-instance-identifier "example-prod-foobar" --master-user-password "パスワード"
  // TODO: parameter storeに入れて、appで取得する：aws ssm put-parameter --name "/example/prod/foobar/DB_PASSWORD" --type "SecureString" --value "パスワード"
  ...
  performance_insights_enabled = false // TODO: 本番ではtrueにする
  ...
  // Deletion protection
  deletion_protection = false // TODO: 本番ではtrueにする
